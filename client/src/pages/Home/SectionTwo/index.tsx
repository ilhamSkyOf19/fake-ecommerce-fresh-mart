...
const SectionTwo: FC = () => {
    ...
    return (
        <div className={`min-h-[100vh] w-full flex flex-col justify-start items-center pt-8  gap-12`}>
            {/* category */}
            ...
            <div className={`w-[75%] h-[22rem] flex flex-row justify-center items-center`}>
...
const Category: FC<CategoryProps> = ({ text1, text2, type }) => {
    return (
        <div className='flex-1 h-full flex flex-row justify-start items-center bg-white rounded-md px-4 gap-2'>
            <div className=''>
                {
            ...
            <div className='flex flex-col justify-start items-start'>
                <p className='capitalize text-to-small font-semibold text-slate-700'>
                    {text1}
                </p>
                <p className='capitalize text-to-small font-semibold text-slate-700'>
                    & {text2}
